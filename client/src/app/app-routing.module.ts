...
import { CapturesEditComponent} from './pages/captures-edit/captures-edit.component';
...
const routes: Routes = [
    ...
    { path: 'captureses/:id',  loadChildren: './pages/captures-edit/captures-edit.module#CapturesEditModule' , canActivate: [AuthGuard] },
